<div id="alcance2">
    ...
    <!--GASES-->
        <div class="form-group row">
            <label name="gasnaturalNm" class="col-form-label col-sm-6">Ggdgdgggfhgghnatural (Nm3)</label>
            <div class="col-sm-6">
                <input id="gasnaturalNm" name="gasnaturalNm" class="form-control">
            </div>
        </div>
        <div class="form-group row">
            <label name="refrigerantes" class="col-form-label col-sm-6">Re3234234432es</label>
            <div class="col-sm-6">
